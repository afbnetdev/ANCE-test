function getAnalisi(e,page){
  Framework7.request.json(endPointUrl+'/PerIlSettore/Get/Analisi', {}, function (data) {
    var listitems="";
...
function getPosizioni(e,page){
  Framework7.request.json(endPointUrl+'/PerIlSettore/Get/Posizioni', {}, function (data) {
    var listitems="";
